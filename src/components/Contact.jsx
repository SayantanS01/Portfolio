...
import { Mail, Briefcase, MessageCircle, Check } from 'lucide-react';
        ...
        <div className="contact-wrapper glass-panel contact-animate">
          <div className="contact-info">
            ...
            <div className="social-links">
              <a
                href="https://github.com/SayantanS01/Portfolio"
                target="_blank"
                rel="noopener noreferrer"
                className="social-icon-btn group"
                aria-label="GitHub Repository"
              >
                <GithubIcon className="w-6 h-6 text-gray-400 group-hover:text-purple-400 transition-colors" />
              </a>
